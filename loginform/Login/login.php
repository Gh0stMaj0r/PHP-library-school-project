                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $_SESSION["firstname"] = $firstname; // Store firstname in session
...
<head>
    ...
    <style>
        body{ font: 14px sans-serif; padding: 100px; 
            ...
            background-image: url(../Images/kirjasto.jpg)
        }
        .wrapper { 
            padding: 20px; 
...
<body>
    <div class="wrapper">
        <h2>Kirjaudu Nettikirjastoon</h2>
        <p>Syötä tiedot kirjautuaksesi palveluun.</p>
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Sinulla ei ole käyttäjää? <a href="register.php">Rekisteröidy nyt</a>.</p>
        </form>
    </div>
</body>
</html>